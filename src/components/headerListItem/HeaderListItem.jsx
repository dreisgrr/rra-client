...
const HeaderListItem = ({type, active, changeType, view}) => {
    ...
    return (
        ...
        <div className={active === true ? view === "admin" ? type === "seats" ? "headerListItem admin disabled" :"headerListItem admin active": "headerListItem active" : view === "admin" ? type === "seats" ? "headerListItem admin disabled" : "headerListItem admin" : type === "seats" ? "headerListItem disabled" : "headerListItem"} onClick={ type !== 'seats' ? changeType : null } >
